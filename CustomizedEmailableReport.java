...
public class CustomizedEmailableReport implements IReporter {
  ...
  protected void startHtml(PrintWriter out) {
	    ...
	    out.println("table {table-layout: fixed;width: 100%;font-family: Arial;margin: 40px 0;font-weight: normal;}");
	    out.println("td {padding: 14px 10px;color: #676767;font-size: 14px; position:relative}");
	    out.println("th {background: #1b72a7;color: #fff;padding: 11px 0;}");
	    ...
	    out.println(".passedeven td:after {border-left: #86b36d 10px solid;content: '';display: block;position: absolute;left: 0;top: 0;bottom: 0;width: 3px;background: #86b36d;}");
	    out.println(".passedeven td: {position: relative;padding-left: 20px;border-left: 0px;}");
	    out.println(".passedeven {border-left: 0px;}");
	    out.println(".passedodd td:after {border-left: #86b36d 10px solid;content: '';display: block;position: absolute;left: 0;top: 0;bottom: 0;width: 3px;background: #86b36d;}");
	    out.println(".passedodd td: {position: relative;padding-left: 20px;border-left: 0px;}");
	    out.println(".passedodd {border-left: 0px;}");
	    out.println(".skippedodd td, .attn {background: none;color: #fd5f5f;font-weight: 700;padding-right: 16px;}");
	    out.println(".skippedodd td {background-color: #DDD}");
	    out.println(".failedeven td:after {border-left: #fd5f5f 10px solid;content: '';display: block;position: absolute;left: 0;top: 0;bottom: 0;width: -1px;background: #fd5f5f;}");
	    out.println(".failedeven td {position: relative;padding-left: 20px;border-left: 0px;}");
	    out.println(".failedeven {border-left: 0px;}");
	    out.println(".failedeven td,.stripe .numi_attn {background: none;}");
	    out.println(".failedodd td:after {border-left: #fd5f5f 10px solid;content: '';display: block;position: absolute;left: 0;top: 0;bottom: 0;width: -1px;background: #fd5f5f;}");
	    out.println(".failedodd td {position: relative;padding-left: 20px;border-left: 0px;}");
	    out.println(".failedodd {border-left: 0px;}");
	    out.println(".failedodd td,.stripe .numi_attn {background: none;}");
	    out.println("table td, table th {border: 0px;border-bottom: #f1f1f1 1px solid;border-right: #f1f1f1 1px solid;}");
	    out.println(".stacktrace {white-space:pre;font-family:monospace}");
	    out.println(".totop {font-size:85%;text-align:center;border-bottom:2px solid #000}");
	    out.println("h3 {font-family: Arial;}");
	    out.println("a {font-family: Arial;color: #1b72a7;text-decoration: none;}");
	    out.println(".passedeven td {background: none;}");
	    out.println("</style>");
	    out.println("</head>");
	    out.println("<body>");
  }
